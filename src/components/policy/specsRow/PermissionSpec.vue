  ...
  <div>
    ...
    <md-table>
      <md-table-row>
        ...
        <md-table-head v-if="creationMode"></md-table-head>
      </md-table-row>
      ...
      >
        ...
        <md-table-cell v-if="creationMode"> </md-table-cell>
      ...
      <md-table-row>
        <md-table-cell>
          <md-field v-if="creationMode">
            ...
            <md-select v-model="newGrantPerm.permission" md-dense>
              <md-option
        ...
        <md-table-cell>
          <md-field v-if="creationMode">
            <label>Action</label>
            <md-select v-model="newGrantPerm.value" md-dense>
              <md-option value="GRANT">Automatiquement validée</md-option>
              <md-option value="DENY">Automatiquement refusée</md-option>
              <md-option value="PROMPT">Gérer par l'utilisateur</md-option>
            </md-select>
          </md-field>
        </md-table-cell>
